// ==UserScript==
// @name         Move and mission tooltip module by Sokol
// @namespace    http://tampermonkey.net/
// @version      0.42069
// @description  Move ship to current planet and mission info in tooltip
// @author       Slava Sokol
...
$(document).ready(function() {
	...
	function MoveButtonClickAction () {
	...
	for (i = 0; i < shipscount; i++) //go through all ship names to find one named "hauler" H hauler ship, thats one to move
		if (playerInfo.shipes[i].name == "hauler"){
			hauler = playerInfo.shipes[i] // if found write him to var
			//console.log( i, "hauler ship" , hauler) //console log for debug
		} //else {
			//console.log( i, "not H ship")}
	//console.log( i, playerInfo.shipes[i].name)
	//copy from ShipMove_UI.prototype.beginMove_ = function(a)
